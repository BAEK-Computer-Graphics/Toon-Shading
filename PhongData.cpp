...
VectorR3 myLightPositions[3] = {
    VectorR3(-2.0, 10.0, -5.0),
	//VectorR3(-50.0, 0.0, 0.0),
    //VectorR3(-40.0, 20.0, 20.0),
...
void MySetupGlobalLight()
{
    ...
    globalPhongData.GlobalAmbientColor.Set(0.7, 0.7, 0.7);
    //globalPhongData.GlobalAmbientColor.Set(0.69, 0.69, 0.966);
...
void MySetupLights()
{
    ...
    // First light (light #0).
    //myLights[0].AmbientColor.Set(1.0, 1.0, 1.0);    // Gray color
    myLights[0].DiffuseColor.Set(0.4, 0.4, 0.4);      // Very light gray
    myLights[0].SpecularColor.Set(0.8, 0.8, 0.8);   // Very light gray
    //myLights[0].IsDirectional = false;
    ...
    myLights[1].DiffuseColor.Set(0.5, 0.5, 0.5);    // Yellow
    myLights[1].SpecularColor.Set(0.8, 0.8, 0.8);   // White
    myLights[1].IsEnabled = false;                     // BE SURE TO ENABLE YOUR LIGHTS
    ...
    myLights[2].IsEnabled = false;                     // BE SURE TO ENABLE YOUR LIGHTS

    //myLights[3].AmbientColor.Set(0.4, 0.4, 0.4);    // Yellow color
	myLights[3].DiffuseColor.Set(0.5, 0.5, 0.5);      // Very light gray
	myLights[3].SpecularColor.Set(0.8, 0.8, 0.8);   // Very light gray
...
void MySetupMaterials()
{
    ...
    myMaterials[0].EmissiveColor.Set(1.0f, 1.0f, 1.0f);   // THIS SHOULD CHANGE TO 0,0,0 SO IT HAS NO EMISSION
    myMaterials[0].AmbientColor.Set(1.0f, 1.0f, 1.0f);
    ...
    myMaterials[1].EmissiveColor.Set(1.0f, 1.0f, 1.0f);   // THIS SHOULD CHANGE TO 0,0,0 SO IT HAS NO EMISSION
    myMaterials[1].AmbientColor.Set(1.0f, 1.0f, 1.0f);
	myMaterials[1].DiffuseColor.Set(0.8f, 0.8f, 0.8f);
	myMaterials[1].SpecularColor.Set(1.0, 1.0, 1.0);
    myMaterials[1].SpecularExponent = 75.0;

    // myMaterials[2]: Material for the surface of rotation
    myMaterials[2].EmissiveColor.Set(1.0f, 1.0f, 1.0f);   // THIS SHOULD CHANGE TO 0,0,0  SO IT HAS NO EMISSION
    myMaterials[2].AmbientColor.Set(1.0f, 1.0f, 1.0f);
    myMaterials[2].DiffuseColor.Set(0.8f, 0.8f, 0.8f);
